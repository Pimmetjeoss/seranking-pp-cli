...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "seranking-pp-cli",
		Short: "Manage seranking resources via the seranking API",
		Long: `Manage seranking resources via the seranking API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'seranking-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("seranking-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'seranking-pp-cli profile list')")

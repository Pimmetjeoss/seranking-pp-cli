...
import (
	...
	"os"
	"regexp"
	"seranking-pp-cli/internal/store"
	"strconv"
	"strings"
	"sync"
	"sync/atomic"
...
Exit codes & warnings:
  ...
  seranking-pp-cli sync

  # Sync specific resources only
  seranking-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  seranking-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  seranking-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  seranking-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  seranking-pp-cli sync --latest-only`,
...
func defaultSyncResources() []string {
	return []string{
		"account",
		"ai-search",
		"ai-search-overview-by-engine-time-series",
		...
		"backlinks-anchors",
		"backlinks-authority",
		"backlinks-authority-domain",
		"backlinks-authority-domain-distribution",
		"backlinks-authority-domain-history",
		"backlinks-authority-page",
		...
		"backlinks-refdomains-count",
		"backlinks-refdomains-history",
		"backlinks-refdomains-history-count",
		"backlinks-referring-ips",
		"backlinks-referring-ips-count",
		...
		"keywords-similar",
		"project-management",
		"project-management-airt-brand",
		"project-management-airt-llm",
		"project-management-airt-llm-statistics",
		"project-management-airt-llm-status",
		"project-management-airt-prompts",
		"project-management-airt-prompts-answer",
		"project-management-airt-prompts-rankings",
		"project-management-competitors",
		"project-management-competitors-metrics",
		"project-management-competitors-positions",
		"project-management-competitors-serp10",
		"project-management-competitors-serp100",
		"project-management-keywords",
		"project-management-sites-ads-stats",
		"project-management-sites-check-dates",
		"project-management-sites-positions",
		"project-management-sites-positions-checkpoints",
		"project-management-sites-positions-history",
		"project-management-sites-search-engines",
		"project-management-sites-summary",
		"project-management-system-google-languages",
		"project-management-system-google-regions",
		"project-management-system-search-engines",
		"project-management-users",
		"project-management-users-me",
		"project-management-users-owned-sites",
		"project-management-users-shared-sites",
		"site-audit",
		"site-audit-audits-history",
		"site-audit-audits-issue-pages",
		"site-audit-audits-issues",
		"site-audit-audits-links",
		"site-audit-audits-pages",
		"site-audit-audits-report",
		"site-audit-audits-status",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account":   "/v1/account/subscription",
		"ai-search": "/v1/ai-search/discover-brand",
		"ai-search-overview-by-engine-time-series":       "/v1/ai-search/overview/by-engine/time-series",
		"ai-search-overview-leaderboard":                 "/v1/ai-search/overview/leaderboard",
		"ai-search-prompts-by-brand":                     "/v1/ai-search/prompts-by-brand",
		"ai-search-prompts-by-target":                    "/v1/ai-search/prompts-by-target",
		"backlinks":                                      "/v1/backlinks/all",
		"backlinks-anchors":                              "/v1/backlinks/anchors",
		"backlinks-authority":                            "/v1/backlinks/authority",
		"backlinks-authority-domain":                     "/v1/backlinks/authority/domain",
		"backlinks-authority-domain-distribution":        "/v1/backlinks/authority/domain/distribution",
		"backlinks-authority-domain-history":             "/v1/backlinks/authority/domain/history",
		"backlinks-authority-page":                       "/v1/backlinks/authority/page",
		"backlinks-authority-page-history":               "/v1/backlinks/authority/page/history",
		"backlinks-count":                                "/v1/backlinks/count",
		"backlinks-history":                              "/v1/backlinks/history",
		"backlinks-history-count":                        "/v1/backlinks/history/count",
		"backlinks-history-cumulative":                   "/v1/backlinks/history/cumulative",
		"backlinks-indexed-pages":                        "/v1/backlinks/indexed-pages",
		"backlinks-metrics":                              "/v1/backlinks/metrics",
		"backlinks-raw":                                  "/v1/backlinks/raw",
		"backlinks-refdomains":                           "/v1/backlinks/refdomains",
		"backlinks-refdomains-count":                     "/v1/backlinks/refdomains/count",
		"backlinks-refdomains-history":                   "/v1/backlinks/refdomains/history",
		"backlinks-refdomains-history-count":             "/v1/backlinks/refdomains/history/count",
		"backlinks-referring-ips":                        "/v1/backlinks/referring-ips",
		"backlinks-referring-ips-count":                  "/v1/backlinks/referring-ips/count",
		"backlinks-referring-subnets-count":              "/v1/backlinks/referring-subnets/count",
		"backlinks-summary":                              "/v1/backlinks/summary",
		"domain":                                         "/v1/domain/ads",
		"domain-competitors":                             "/v1/domain/competitors",
		"domain-keywords":                                "/v1/domain/keywords",
		"domain-keywords-comparison":                     "/v1/domain/keywords/comparison",
		"domain-overview-db":                             "/v1/domain/overview/db",
		"domain-overview-history":                        "/v1/domain/overview/history",
		"domain-overview-worldwide":                      "/v1/domain/overview/worldwide",
		"domain-overview-worldwide-url":                  "/v1/domain/overview/worldwide/url",
		"domain-pages":                                   "/v1/domain/pages",
		"domain-subdomains":                              "/v1/domain/subdomains",
		"keywords":                                       "/v1/keywords/export",
		"keywords-longtail":                              "/v1/keywords/longtail",
		"keywords-questions":                             "/v1/keywords/questions",
		"keywords-related":                               "/v1/keywords/related",
		"keywords-similar":                               "/v1/keywords/similar",
		"project-management":                             "/v1/project-management/sites",
		"project-management-airt-brand":                  "/v1/project-management/airt/brand",
		"project-management-airt-llm":                    "/v1/project-management/airt/llm",
		"project-management-airt-llm-statistics":         "/v1/project-management/airt/llm/statistics",
		"project-management-airt-llm-status":             "/v1/project-management/airt/llm/status",
		"project-management-airt-prompts":                "/v1/project-management/airt/prompts",
		"project-management-airt-prompts-answer":         "/v1/project-management/airt/prompts/answer",
		"project-management-airt-prompts-rankings":       "/v1/project-management/airt/prompts/rankings",
		"project-management-competitors":                 "/v1/project-management/competitors",
		"project-management-competitors-metrics":         "/v1/project-management/competitors/metrics",
		"project-management-competitors-positions":       "/v1/project-management/competitors/positions",
		"project-management-competitors-serp10":          "/v1/project-management/competitors/serp10",
		"project-management-competitors-serp100":         "/v1/project-management/competitors/serp100",
		"project-management-keywords":                    "/v1/project-management/keywords",
		"project-management-sites-ads-stats":             "/v1/project-management/sites/ads-stats",
		"project-management-sites-check-dates":           "/v1/project-management/sites/check-dates",
		"project-management-sites-positions":             "/v1/project-management/sites/positions",
		"project-management-sites-positions-checkpoints": "/v1/project-management/sites/positions/checkpoints",
		"project-management-sites-positions-history":     "/v1/project-management/sites/positions/history",
		"project-management-sites-search-engines":        "/v1/project-management/sites/search-engines",
		"project-management-sites-summary":               "/v1/project-management/sites/summary",
		"project-management-system-google-languages":     "/v1/project-management/system/google/languages",
		"project-management-system-google-regions":       "/v1/project-management/system/google/regions",
		"project-management-system-search-engines":       "/v1/project-management/system/search-engines",
		"project-management-users":                       "/v1/project-management/users",
		"project-management-users-me":                    "/v1/project-management/users/me",
		"project-management-users-owned-sites":           "/v1/project-management/users/owned-sites",
		"project-management-users-shared-sites":          "/v1/project-management/users/shared-sites",
		"site-audit":                                     "/v1/site-audit/audits",
		"site-audit-audits-history":                      "/v1/site-audit/audits/history",
		"site-audit-audits-issue-pages":                  "/v1/site-audit/audits/issue-pages",
		"site-audit-audits-issues":                       "/v1/site-audit/audits/issues",
		"site-audit-audits-links":                        "/v1/site-audit/audits/links",
		"site-audit-audits-pages":                        "/v1/site-audit/audits/pages",
		"site-audit-audits-report":                       "/v1/site-audit/audits/report",
		"site-audit-audits-status":                       "/v1/site-audit/audits/status",
	}
